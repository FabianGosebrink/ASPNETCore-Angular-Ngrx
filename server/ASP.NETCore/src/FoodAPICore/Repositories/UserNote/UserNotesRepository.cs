...
namespace FoodAPICore.Repositoriess
{
    public class UserNotesRepository : IUserNotesRepository
    {
        ...
        public UserNotesRepository(FoodDbContext context, ILoggerFactory loggerFactory) {
          _Context = context;
        ...
        public async Task<List<User>> GetUserNotesAsync()
        {
            return await _Context.Users.Include(n=>n.Notes).ToListAsync();
        }
